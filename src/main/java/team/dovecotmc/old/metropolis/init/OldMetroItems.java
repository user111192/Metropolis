...
public class OldMetroItems {
    ...
    public static final Item ITEM_PSD_JR_OUTER_DOOR_1 = register("psd_jr_outer_door_1", new ItemBlockWithTooltips(OldMetroBlocks.BLOCK_PSD_JR_OUTER_DOOR_1, new Item.Properties()));
    public static final Item ITEM_PSD_JR_OUTER_DOOR_2 = register("psd_jr_outer_door_2", new ItemBlockWithTooltips(OldMetroBlocks.BLOCK_PSD_JR_OUTER_DOOR_2, new Item.Properties()));
    public static final Item ITEM_PSD_JR_INNER_DOOR_1 = register("psd_jr_inner_door_1", new ItemBlockWithTooltips(OldMetroBlocks.BLOCK_PSD_JR_INNER_DOOR_1, new Item.Properties()));
    public static final Item ITEM_PSD_JR_INNER_DOOR_2 = register("psd_jr_inner_door_2", new ItemBlockWithTooltips(OldMetroBlocks.BLOCK_PSD_JR_INNER_DOOR_2, new Item.Properties()));
